"""Add column to notify table

Revision ID: 64f4c0226b97
Revises: 1762aefbfb6c
Create Date: 2023-12-04 11:53:30.062763
...
revision: str = '64f4c0226b97'
down_revision: Union[str, None] = '1762aefbfb6c'
...
def upgrade() -> None:
    ...
    op.add_column('notify', sa.Column('notify_name', sa.String(length=40), nullable=False))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('notify', 'notify_name')
